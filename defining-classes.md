...
![图1-1  物种之间的分类关系](https://github.com/andguoan/programming-with-objective-c/blob/master/images/humansgorillas.png)  
...
![图 1-2  NSMutableString 的继承](https://github.com/andguoan/programming-with-objective-c/blob/master/images/nsstringmutablestring.png)
...
![图 1-3  UIButton 类的继承](https://github.com/andguoan/programming-with-objective-c/blob/master/images/buttoninheritance.png)
...
@end
```
属性的特性在括号内的  @property  关键字后指定，完整地在声明的[公共属性公开的数据中](https://developer.apple.com/library/mac/documentation/Cocoa/Conceptual/ProgrammingWithObjectiveC/EncapsulatingData/EncapsulatingData.html#//apple_ref/doc/uid/TP40011210-CH5-SW4)描述。
...
####Methods可以使用参数 - Methods Can Take Parameters  
...
这是一个有助于使 Objective-C 更加可读的语言，因为通过方法调用传递的值是指定的内联函数 ，旁边的方法名称的相关部分在You Can Pass Objects for Method Parameters
中有所描述。
...
在下一章中你会看到更多例子的方法实现，Working with Objects。
